...
public class CorporateActionController {
  ...
  public ResponseEntity<CorporateActionDto> createCorporateAction(
      @RequestBody CorporateActionDto corporateActionDto) {
    try {
      CorporateActionDto createdCorporateAction =
          corporateActionService.createCorporateAction(corporateActionDto);
