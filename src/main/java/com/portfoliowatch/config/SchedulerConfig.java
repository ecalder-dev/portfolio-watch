...
public class SchedulerConfig {
    ...
    public void nightlyJobs() {
        ...
        // and check if it is not before the current date. If it's not, trigger the rebuilding of all lots.
        List<Date> latestUpdates = List.of(transactionService.getDateOfLastUpdate(), transferService.getDateOfLastUpdate(), corporateActionService.getDateOfLastUpdate());
